        ...
        <div class="py-4 px-6 ">
            <div class="grid grid-cols-12 gap-6 ">
                <div class="col-span-12 sm:col-span-5 shadow-md rounded-md px-4 py-2 dark:bg-gray-200  h-48">
                    <h2 class="text-2xl text-black font-semibold py-2">{{ __('Section') }}</h2>
                ...
                <div class="col-span-12 sm:col-span-7 shadow-md rounded-md  dark:bg-gray-200  min-h-96 ">
                    <x-table.table class="relative w-full ">
                        <x-slot name="header">
                            <x-table.heading.heading class="text-center sticky top-0 bg-gray-100">#</x-table.heading.heading>
                            
                            <x-table.heading.heading class="text-center sticky top-0 bg-gray-100">{{ __('Section') }}</x-table.heading.heading>
                            

                            
                            <x-table.heading.heading class="text-center sticky top-0 bg-gray-100">{{ __('Action') }}</x-table.heading.heading>
