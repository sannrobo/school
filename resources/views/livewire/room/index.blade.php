    ...
    <div class="container grid px-6 mx-auto">
        ...
        <div class="py-2 px-6 ">
            <div class="grid grid-cols-12 gap-6 ">
                ...
                <div class="col-span-12 sm:col-span-7 shadow-md rounded-md  dark:bg-gray-200 h-40">
                    <x-table.table class=" w-full h-full ">
                        <x-slot name="header">
                            <x-table.heading.heading class="text-center  bg-gray-100">#</x-table.heading.heading>
                            
                            <x-table.heading.heading class="text-center  bg-gray-100">{{ __('Room Name') }}</x-table.heading.heading>
                        ...
                        <x-slot name="body">
                            ...
                            @forelse ($rooms as $r)
                                <x-table.row.row class="text-center">
                                    ...
                                    <x-table.cell.cell>{{ $r->name }}</x-table.cell.cell>
                                
                                    <x-table.cell.cell>{{ $r->description }}</x-table.cell.cell>
                                    ...
                                    <x-table.cell.cell>
                                        @can('update_room')
                                        <button wire:click="Edit({{ $r->id }})" class="focus:border-transparent focus:outline-none">
                                        ...
                                        @endcan
                                        @can('delete_room')
                                        <button class="focus:outline-none" wire:loading.attr="disabled" wire:click.prevent="deleteConfirm({{ $r->id }})">
                    ...
                    <div class="col-span-12">
                        ...
                        {{ $rooms->links('custom-pagination-links-view') }}     
                    </div>
